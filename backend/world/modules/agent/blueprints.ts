...
const COLLABORATION_TOOLS = ['list_agents', 'send_agent_message', 'followup_agent_task', 'read_agent_messages', 'wait_agent_messages', 'agent_board'];
...
const READONLY_TOOLS = [TASK_LIST_TOOL_NAME, ASK_USER_TOOL_NAME, SUBMIT_PLAN_TOOL_NAME, SWITCH_WORK_ENVIRONMENT_TOOL_NAME, READ_TOOL_NAME, 'shell', 'bash', SKILLS_TOOL_NAME, SUBMIT_AGENT_ANSWER_TOOL_NAME, READ_AGENT_ANSWER_TOOL_NAME, 'list_agents', 'send_agent_message', 'read_agent_messages', 'wait_agent_messages', 'agent_board'];
